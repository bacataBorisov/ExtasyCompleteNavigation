...
final class WaypointProcessorTests: XCTestCase {
    ...
    func testCalculateTrueMarkBearingInSouthernHemisphereDueEast() {
        let start = CLLocationCoordinate2D(latitude: -33.0, longitude: 18.0)
        let mark = CLLocationCoordinate2D(latitude: -33.0, longitude: 19.0)
        XCTAssertEqual(processor.calculateTrueMarkBearing(from: start, to: mark), 90.0, accuracy: 0.5)
    }
    ...
    func testFindIntersectionRejectsCrossingBeyondMaxDistance() {
        let line1Start = CLLocationCoordinate2D(latitude: 0.0, longitude: 0.0)
        let line1End = CLLocationCoordinate2D(latitude: 1.0, longitude: 1.0)
        let line2Start = CLLocationCoordinate2D(latitude: 0.0, longitude: 1.0)
        let line2End = CLLocationCoordinate2D(latitude: 1.0, longitude: 0.0)
    ...
    func testFindIntersectionRejectsWhenCrossingOutsideSegments() {
        let line1Start = CLLocationCoordinate2D(latitude: 0.0, longitude: 0.0)
        let line1End = CLLocationCoordinate2D(latitude: 0.2, longitude: 0.2)
        let line2Start = CLLocationCoordinate2D(latitude: 0.0, longitude: 1.0)
        let line2End = CLLocationCoordinate2D(latitude: 0.2, longitude: 0.8)
    ...
    func testCalculateLaylineCoordinatesNegativeBearingMatchesPositiveEquivalent() {
        let start = CLLocationCoordinate2D(latitude: 43.0, longitude: 28.0)
        let negative = processor.calculateLaylineCoordinates(start: start, bearing: -45.0, distance: 1_000)
        let normalized = processor.calculateLaylineCoordinates(start: start, bearing: 315.0, distance: 1_000)

        XCTAssertEqual(negative.latitude, normalized.latitude, accuracy: 1e-8)
        XCTAssertEqual(negative.longitude, normalized.longitude, accuracy: 1e-8)
    }
    ...
    func testGenerateDiamondLaylinesReturnsTwoIntersectionsForSymmetricDownwindCase() {
        let boat = CLLocationCoordinate2D(latitude: 0.0, longitude: 0.0)
        let mark = CLLocationCoordinate2D(latitude: -0.01, longitude: 0.0)
    ...
    func testGenerateDiamondLaylinesUsesDistanceFloorForShortLegs() {
        let boat = CLLocationCoordinate2D(latitude: 0.0, longitude: 0.0)
        let mark = CLLocationCoordinate2D(latitude: 0.0001, longitude: 0.0)
    ...
    func testCalculateTackStateChoosesIntersectionClosestToCurrentHeading() {
        let boat = CLLocationCoordinate2D(latitude: 0.0, longitude: 0.0)
        let ahead = (intersection: CLLocationCoordinate2D(latitude: 1.0, longitude: 0.0), distanceBoat: 10.0, distanceWaypoint: 20.0)
        let starboard = (intersection: CLLocationCoordinate2D(latitude: 0.0, longitude: 1.0), distanceBoat: 30.0, distanceWaypoint: 40.0)
    ...
    func testCalculateTackStateRemainsStableAcrossHeadingWrap() {
        let boat = CLLocationCoordinate2D(latitude: 0.0, longitude: 0.0)
        let nearNorthWest = (intersection: CLLocationCoordinate2D(latitude: 1.0, longitude: -0.1), distanceBoat: 12.0, distanceWaypoint: 18.0)
        let east = (intersection: CLLocationCoordinate2D(latitude: 0.0, longitude: 1.0), distanceBoat: 25.0, distanceWaypoint: 30.0)
    ...
    func testCalculateTackStateNegativeHeadingMatchesEquivalentPositiveHeading() {
        let boat = CLLocationCoordinate2D(latitude: 0.0, longitude: 0.0)
        let north = (intersection: CLLocationCoordinate2D(latitude: 1.0, longitude: 0.1), distanceBoat: 14.0, distanceWaypoint: 19.0)
        let south = (intersection: CLLocationCoordinate2D(latitude: -1.0, longitude: 0.0), distanceBoat: 50.0, distanceWaypoint: 60.0)
