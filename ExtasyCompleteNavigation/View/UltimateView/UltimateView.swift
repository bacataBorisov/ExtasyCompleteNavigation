        ...
        NavigationStack {
            ...
            GeometryProvider{ width, geometry in
                ...
                ZStack {
                    ...
                    CompassView(heading: navigationReadings.compassData?.smoothedHeading ?? 0, width: width, geometry: geometry)
                    
                    //MARK: - Bearing to Mark Marker
                    BearingMarkerView(relativeMarkBearing: navigationReadings.relativeMarkBearing, isVMGSelected: navigationReadings.isVMGSelected, width: width)
                }//END OF ZSTACK
            }//END OF GEOMETRY
            .ignoresSafeArea()
