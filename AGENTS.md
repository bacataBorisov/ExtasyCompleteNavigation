...
4. Prefer **[`.agent/ROADMAP.md`](.agent/ROADMAP.md)** and **[`.agent/CHANGELOG.md`](.agent/CHANGELOG.md)** for scope and recent decisions. For **session handoff**, see **[`.agent/HANDOFF.md`](.agent/HANDOFF.md)**.
